...
ComPtr<ID3DBlob> Util::LoadBinary(const wstring& filename)
{
...
const float UtilMath::Infinity = FLT_MAX;
const float UtilMath::Pi = 3.1415926535f;

///////// Resources


Resource::Resource(ID3D12Device* device, UINT passCount, UINT objectCount)
{
